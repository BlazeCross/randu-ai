  ...
  return (
    <div className="space-y-4">
            ...
            >
              ...
              <div className="mb-3 flex items-center justify-between">
                <span className="inline-flex items-center gap-2 text-xs font-medium text-muted-foreground">
                  <span className="flex h-5 w-5 items-center justify-center rounded bg-muted text-[10px]">
                    {index + 1}
                  </span>
                  字段
                </span>
              ...
              <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
                ...
                <div>
                  <label className="mb-1 block text-xs font-medium text-muted-foreground">
                    ...
                    <span className="ml-1 font-normal text-muted-foreground">（前端 name 属性）</span>
                  </label>
                  <input
                    type="text"
                    value={field.name}
                    ...
                    className="w-full rounded-[var(--radius-sm)] border border-border px-3 py-1.5 text-sm focus:border-primary focus:outline-none focus:ring-1 focus:ring-primary"
                  />
                </div>
              ...
              {field.type === "select" && (
                <div className="mt-3">
                  <label className="mb-1 block text-xs font-medium text-muted-foreground">
                    ...
                    <span className="ml-1 font-normal text-muted-foreground">（每行一个选项）</span>
                  </label>
                  <textarea
      ...
      <button
        type="button"
        onClick={addField}
        className="flex w-full items-center justify-center gap-1.5 rounded-[var(--radius-sm)] border border-dashed border-border bg-card py-2.5 text-sm font-medium text-muted-foreground transition-colors hover:border-primary hover:bg-primary-50 hover:text-primary-700"
      >
        <svg className="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={2}>
