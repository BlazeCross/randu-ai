            ...
            {CATEGORIES.map((cat) => {
              ...
              return (
                <button
                  ...
                  className={cx(
                    "flex-none rounded-full px-4 py-1.5 text-sm font-medium transition-all duration-200",
                    active
                      ? "text-primary-foreground shadow-[var(--shadow-sm)]"
                    ...
                    <div className="flex flex-1 flex-col p-5">
                      ...
                      <div className="mb-4 flex items-center justify-between gap-2">
                        ...
                        <span className="inline-flex items-center gap-1 text-xs font-medium text-muted-foreground">
                          <svg className="h-3.5 w-3.5 text-warning" fill="currentColor" viewBox="0 0 20 20" aria-hidden>
